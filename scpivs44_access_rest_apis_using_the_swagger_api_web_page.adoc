...
---
= SCV용 Swagger API 웹 페이지를 사용하여 REST API에 액세스합니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
.시작하기 전에
SnapCenter Plug-in for VMware vSphere 액세스하려면 SnapCenter Plug-in for VMware vSphere 의 IP 주소 또는 호스트 이름이 있는지 확인하세요.
