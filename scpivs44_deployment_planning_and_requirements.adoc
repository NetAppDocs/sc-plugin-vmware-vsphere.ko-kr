...
+
지원되는 ONTAP 도구 버전에 대한 최신 정보는 를 참조하십시오 https://imt.netapp.com/matrix/imt.jsp?components=108380;&solution=1257&isHWU&src=IMT["NetApp 상호 운용성 매트릭스 툴"^].
...
| VMware용 ONTAP 툴 | VMware vSphere용 SnapCenter 플러그인은 이 플러그인을 사용하여 VVOL 데이터 저장소(VMware 가상 볼륨)를 관리합니다. 지원되는 버전은 를 참조하십시오 https://imt.netapp.com/matrix/imt.jsp?components=108380;&solution=1257&isHWU&src=IMT["NetApp 상호 운용성 매트릭스 툴"^]. 
|===
