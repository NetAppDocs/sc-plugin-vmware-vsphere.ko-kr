...
| VMware용 ONTAP 툴 | SnapCenter Plug-in for VMware vSphere 이를 사용하여 vVol 데이터스토어(VMware 가상 볼륨)를 관리합니다. 지원되는 버전은 다음을 참조하세요. https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp 상호 운용성 매트릭스 툴"^] . 


| NetApp ONTAP 스토리지용 Amazon FSxN | 9.10 이상 
|===
지원되는 버전에 대한 최신 정보는 다음을 참조하세요. https://imt.netapp.com/imt/imt.jsp?components=180121;&solution=1517&isHWU&src=IMT["NetApp 상호 운용성 매트릭스 툴"^] .
