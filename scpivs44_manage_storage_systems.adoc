...
---
= SnapCenter Plug-in for VMware vSphere에서 스토리지 시스템을 관리합니다
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
IMPORTANT: SnapCenter 사용자 인터페이스를 사용하여 애플리케이션 기반 데이터 보호 작업을 위한 스토리지 VM을 추가한 경우 동일한 사용자 인터페이스를 사용하여 해당 스토리지 VM을 수정해야 합니다.
...
NOTE: SnapCenter 사용자 인터페이스를 사용하여 애플리케이션 기반 데이터 보호 작업을 위한 스토리지 VM을 추가한 경우 동일한 사용자 인터페이스를 사용하여 해당 스토리지 VM을 수정해야 합니다.
