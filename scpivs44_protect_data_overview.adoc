...
---
= SnapCenter Plug-in for VMware vSphere를 위한 데이터 보호 워크플로우
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
NOTE: NetApp Backup and Recovery를 사용하여 VMware 보호 기능을 강화하세요. 3-2-1 백업, 랜섬웨어 보호, 자동화된 백업 관리, 향상된 확장성, 비용 절감, 그리고 여러 vCenter 인스턴스의 중앙 집중식 관리를 제공합니다. SCV 정책, 스냅샷, 일정을 NetApp Backup and Recovery로 마이그레이션하고 단일 콘솔에서 모든 VM 보호를 관리할 수 있습니다. 자세한 내용은 link:https://docs.netapp.com/us-en/data-services-backup-recovery/["NetApp Backup and Recovery 설명서"]을(를) 참조하십시오.
