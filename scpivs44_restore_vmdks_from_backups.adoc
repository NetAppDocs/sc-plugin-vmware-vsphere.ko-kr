...
+
특정 백업 이름 또는 일부 백업 이름을 검색하거나 필터 아이콘을 클릭하고 날짜 및 시간 범위를 선택하고, VMware 스냅샷이 포함된 백업을 사용할지 여부, 마운트된 백업을 원하는지 또는 보조 위치를 선택하여 백업 목록을 필터링할 수 있습니다. 확인 * 을 클릭하여 마법사로 돌아갑니다.
