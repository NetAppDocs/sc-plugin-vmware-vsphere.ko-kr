...
---
= SnapCenter Plug-in for VMware vSphere의 업그레이드 경로
:allow-uri-read: 
...
[NOTE]
====
SnapCenter Plug-in for VMware vSphere(SCV) 4.8 이상으로의 업그레이드는 VMware vCenter Server 7 업데이트 1 이상 버전에서만 지원됩니다. VMware vCenter Server 7 업데이트 1 이전 버전을 사용하는 경우 SCV 4.7을 계속 사용하십시오.
